...
class KeyBindMenu extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		keyTextDisplay = new FlxFixedText(-10, 0, 1280, "", 72);
		...
		warnText = new FlxFixedText(-10, 480, 1280, 'All keybinds need to be assigned!', 72);
	...
	override function update(elapsed:Float)
	{
		...
		switch(state){
			...
			case "select":
				...
				if (controls.ACCEPT && !KeyBinds.gamepad){
					FlxG.sound.play(Paths.sound('scrollMenu'));
					state = "input";
				}
